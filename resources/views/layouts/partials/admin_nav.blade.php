...
<div class="navbar-fixed">
    <nav>
        <div class="nav-wrapper">
            <a href="{{ route('user_pages.home')}}" class="brand-logo center-align center"><i class="fa fa-rocket"></i> GyanMitra18 Admin</a>
            <ul class="left">
                <li>
            ...
            <ul class="side-nav" id="slide-out">
                ...
                @endif
                @if(Auth::user()->hasRole('root') || Auth::user()->hasRole('hospitality') )
                    <li class="no-padding">
                        <ul class="collapsible collapsible-accordion">
                            <li>
